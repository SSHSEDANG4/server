...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/syapik96/server/main/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/syapik96/server/main/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/syapik96/server/main/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/syapik96/server/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
